	...
	<div class="container">
		...
		<form name="writeFrm" method="post" action="./passwordAction.do"
			...
			<!-- 파라미터 저장용도의 hidden박스
				...
				mode의 경우 EL의 내장객체인 param을 통해 view에서 파라미터를 받아서 출력한다.
			이와같이 파라미터를 view에서 바로 사용할 때는 굳으 reques내장객체를 통해
			폼값을 받지 않아도 된다.
			 -->
			<input type="hid den" name="idx" value="${idx }" /> <input
				type="hid den" name="mode" value="${param.mode }" /> <input
